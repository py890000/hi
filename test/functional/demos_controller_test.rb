...
class DemosControllerTest < ActionController::TestCase
  ...
  test "should create demo" do
    assert_difference('Demo.count') do
      post :create, demo: { login_name: @demo.login_name, login_password: @demo.login_password, userInfo: @demo.userInfo }
    end
  ...
  test "should update demo" do
    put :update, id: @demo, demo: { login_name: @demo.login_name, login_password: @demo.login_password, userInfo: @demo.userInfo }
    assert_redirected_to demo_path(assigns(:demo))
  end
